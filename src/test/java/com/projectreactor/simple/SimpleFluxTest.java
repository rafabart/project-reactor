package com.projectreactor.simple;
...
public class SimpleFluxTest {
    ...
    void simpleFluxExample() {
        ...
        //OnNext() -> Vai ser executado para cada item do conjunto Flux
    ...
    //Zips multiple sources togheter (waiting for all the sources to emit one element and combining them into a Tuple)
    @Test
    void zipExample() {
    ...
    //Erro terminal - quebra da cadeia de operções
    @Test
    ...
    //Erro terminal manipulado com .onErrorReturn. Não ocorre a quebra da cadeia de operações.
    @Test
    ...
    //StepVerifier -> when the verify method is called and then 'StepVerifier' compares the emitted values to your defined expectations.
    @Test
